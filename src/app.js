...
class AvaibleCurrencies extends React.Component {
  ...
  render() {
    ...
    let currency = this.props.currency.map(function (item, index) {
      return (
        <div key={index} className="ik-avaible-currencies__row">
          ...
          <button className={`ik-avaible-currencies__day-progress  ${Math.round(((item.Cur_OfficialRate - yesterdayCurrency[index].Cur_OfficialRate)*10000)/10000 > 0) ? rizeStyle : downStyle}`}>
    ...
    return (
      <div className={`ik-avaible-currencies  ${pageElementClass}`}>
        {currency}
      </div>
    );
  }
...
class DateCurrencyTable extends React.Component {
  render() {
  ...
  render() {
    return (
      <div className="ik-currency-page">
          ...
          <AvaibleCurrencies className="ik-currency-page__avaible-currencies" currency={this.props.currency} yesterdayCurrency = {this.props.yesterdayCurrency} />
          <Tableplace className="ik-currency-page__output-table" />
      </div>
    )
  }
}
